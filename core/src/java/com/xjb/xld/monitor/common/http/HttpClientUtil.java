package com.xjb.xld.monitor.common.http;
...
import com.xjb.xld.monitor.common.exception.PayException;
import com.xjb.xld.monitor.common.support.ResponseCode;
...
public class HttpClientUtil {
	...
	public static String post(RequestParameter parameter, int timeout,
		...
		try {
			...
			throw new PayException(ResponseCode.SYSTEM_ERROR, e);
		} catch (Exception e) {
			throw new PayException(ResponseCode.SYSTEM_ERROR, e);
		} finally {
	...
	public static String httpPost(RequestParameter parameter,
			Map<String, String> map, int timeout) {
	 ...
	 */
	public static String httpPost(RequestParameter parameter,
			List<NameValuePair> list, int timeout) {
		HttpPost post = new HttpPost(parameter.getUrl());
		String responseString = null;
		try {
	...
	public static String get(RequestParameter parameter, int connectTimeout,
		...
		try {
			...
			try {
				...
				log.error(HttpClientUtil.class.getName(), e);
				return responseString;
			} finally {
				if (response != null) {
					response.close();
